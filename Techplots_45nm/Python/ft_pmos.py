...
# Define the CSV file path for PMOS Ft vs gm/Id
file_path = r"D:\Desktop\PE\Techplots_45nm\Techplots_45nm\PMOS_tp_45nm\ft.csv"
...
try:
    ...
    if data.shape[1] < 2:
        ...
        for i in range(num_pairs):
            ...
            lines.append(line)
            line_labels[line] = f"l_pmos = {length_nm:.1f} nm"

        # Add plot labels and grid
        ax.set_title("PMOS: Ft vs gm/Id for Different Lengths")
        ax.set_xlabel(r'$\frac{g_m}{|I_{ds}|}$')
        ax.set_ylabel(r'$\frac{g_m}{2\pi C_{gg}}$ (GHz)')
        ax.grid(True)
