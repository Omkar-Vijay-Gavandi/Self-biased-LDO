...
# Define the CSV file path for NMOS Id/W vs gm/Id
file_path = r"D:\Desktop\PE\Techplots_45nm\Techplots_45nm\NMOS_tp_45nm\idw.csv"
...
try:
    ...
    if data.shape[1] < 2:
        ...
        ax.set_title("NMOS: Id/W vs gm/Id for Different Lengths")
        ax.set_xlabel("gm/Id")
        ax.set_ylabel("Id/W")
        ax.grid(True)
