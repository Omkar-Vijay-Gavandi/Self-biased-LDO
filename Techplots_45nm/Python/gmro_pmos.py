...
# Define the CSV file path for PMOS data
file_path = r"D:\Desktop\PE\Techplots_45nm\Techplots_45nm\PMOS_tp_45nm\gmro.csv"
...
try:
    ...
    if data.shape[1] < 2:
        ...
        # Generate corresponding lengths dynamically
        start_length = 45  # nm
        step_size = 22.5   # nm
        ...
        ax.set_title("PMOS: gmro vs gm/Id for Different Lengths")
        ax.set_xlabel("gm/Id")
        ax.set_ylabel("gmro")
        ax.grid(True)
